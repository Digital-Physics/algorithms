...
print("it is ok to set one variable equal to another if the either object will later be re-assigned")
print("if an variable is reassigned (not mutated) the pointers will then point to different objects")
